    ...
    <section class="header">
        ...
        <?php
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo "SSN: " . $row["SALESMAN_SSN"]. "<br> Name: " . $row["SALESMAN_NAME"]. "<br> Company Name: " . $row["COMPANY_NAME"]. "<br> Promote Drug with serial code: " . $row["DRUG_SERIAL_CODE"]. "<br> Experience: " . $row["EXPERIENCE"]. "<br> Your salary: " . $row["SALARY"]. "<br><br>";
            } else {
                echo "0 results !!";
            }
        ?>
