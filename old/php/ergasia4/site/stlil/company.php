    ...
    <section class="header">
        ...
        <?php
            ...
            #$query = "SELECT * FROM COMPANY WHERE COMPANY_NAME = '$company_name' ";
                        #$query_2 = "SELECT d.DRUG_NAME, d.SERIAL_CODE, DISTRIBUTOR_NAME, SALESMAN_NAME FROM DRUG d, BUY b, SALESMAN s WHERE d.COMPANY_NAME = 'Pfizer' AND b.COMPANY_NAME = 'Pfizer' AND s.COMPANY_NAME = 'Pfizer' ";

                        $query2 = "SET @COMP_NAME := '$company_name';
        ...
        $empQuery = "SELECT d.DRUG_NAME, d.SERIAL_CODE, b.DISTRIBUTOR_NAME, s.SALESMAN_NAME FROM DRUG d, BUY b, SALESMAN s WHERE d.COMPANY_NAME = '$company_name' AND b.COMPANY_NAME = '$company_name' AND s.COMPANY_NAME = '$company_name'";
                    ...
                    $result = mysqli_query($con, $empQuery);
                    if (mysqli_num_rows($result) > 0) {
                        // output data of each row
                        $row = mysqli_fetch_assoc($result);
                        //echo "Company: " . $row["COMPANY_NAME"]. "<br> Income/Outcome: " . $row["INCOME_OUTCOME"]. "<br> HQ Address: " . $row["HQ_ADDRESS"]. "<br> Number of Salesmen: " . $row["NUMBER_OF_SALESMEN"]. "<br> Number of Factories: " . $row["NUMBER_OF_FACTORIES"]. "<br> Rate of production of new drugs: " . $row["NEW_DRUG_RATE"]. "<br><br>";
  ...
  //      "serverSide" : true,
        'columns': [
          ...
          /*"data": [{
                    "DRUG_NAME": "Panadol",
                    "SERIAL_CODE": "001",
                    "DISTRIBUTOR_NAME": "Banana",
                    "SALESMAN_NAME": "Thomas"
}]*/
'ajax' :  'data.json'
        /*'ajax': {
