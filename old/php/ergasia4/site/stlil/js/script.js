    ...
    $(function() {
        ...
        function attachFormValidator(elements) {
            ...
            var regularConstraintsMessages = [{
                    ...
                    newMessage: "Το πεδίο είναι υποχρεωτικό."
                },
                {
                    type: regula.Constraint.Email,
                    newMessage: "Το email δεν είναι έγκυρο."
                },
                {
                    type: regula.Constraint.Numeric,
                    newMessage: "Μόνο νούμερα"
                },
                {
                    type: regula.Constraint.Selected,
                    newMessage: "Η επιλογή είναι υποχρεωτική."
                }
            ];
        ...
        if (plugins.rdMailForm.length) {
            var i, j, k,
                msg = {
                    'MF000': 'Στάλθηκε με επιτυχία!',
                    'MF001': 'Recipients are not set!',
                    'MF002': 'Form will not work locally!',
                    'MF003': 'Παρακαλώ, συμπληρώστε το email σας!',
                    'MF004': 'Please, define type of your form!',
                    'MF254': 'Something went wrong with PHPMailer!',
                    'MF255': 'Κάτι πήγε στραβά, προσπαθήστε ξανά αργότερα.'
                };
                ...
                $form.attr('novalidate', 'novalidate').ajaxForm({
                    ...
                    beforeSubmit: function(arr, $form, options) {
                        ...
                        if (isValidated(inputs, captcha)) {
                            ...
                            if (output.hasClass("snackbars")) {
                                output.html('<p><span class="icon text-middle fa fa-circle-o-notch fa-spin icon-xxs"></span><span>Αποστολή...</span></p>');
                                output.addClass("active");
                            }
                        } else {
                            return false;
