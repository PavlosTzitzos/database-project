...
<body>
    <section class="header">
        ...
        #create query(COMPANY_NAME,HQ_ADDRESS,INCOME_OUTCOME,NUMBER_OF_SALESMEN,NUMBER_OF_FACTORIES,NEW_DRUG_RATE)
        $q_insert = "INSERT INTO COMPANY VALUES('$company_name','$hqaddress','$in_out','$n_salesmen','$n_factories','$new_drug_rate') ";
