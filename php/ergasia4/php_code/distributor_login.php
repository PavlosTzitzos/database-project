...
<body>
    <section class="header">
        ...
        <form method="GET" action="distributor.php"  name="myform">
            <label for="user">Distributor Name:</label><br>
            <input type="text" name="distributor_name"><br>
        ...
        <script language="JavaScript" type="text/javascript">
            ...
            frmvalidator.addValidation("distributor_name","req","Please give a valid name !");
        </script>
</section>
</body>
</html>
