...
<center>
  ...
  <p align="center">&nbsp;</p>
    ...
    <form method="POST" action="insert_sample.php"  name="myform">
      <center>
      <table>
        <tr>
        <td>
      <div align="center"><strong>SSN:</strong> <input name="your social security number" type="text" size="50"/></div><br>
...
//You should create the validator only after the definition of the HTML form
  ...
  frmvalidator.addValidation("ssn","req","Please give a valid ssn !");
</script>
</body>
</html>
