...
<body>
    <section class="header">
        ...
        <form method="GET" action="patient.php"  name="myform">
            <label for="user">Patient ssn:</label><br>
            <input type="text" name="patient_ssn"><br>
        ...
        <script language="JavaScript" type="text/javascript">
            ...
            frmvalidator.addValidation("patient_ssn","req","Please give a valid ssn !");
        </script>
</section>
</body>
</html>
