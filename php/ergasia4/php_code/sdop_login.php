...
<body>
    <section class="header">
        ...
        <form method="GET" action="sdop.php"  name="myform">
            <label for="user">State Deposit of Pharmaceuticals:</label><br>
            <input type="text" name="sdop_name"><br>
        ...
        <script language="JavaScript" type="text/javascript">
            ...
            frmvalidator.addValidation("sdop_name","req","Please give a valid name !");
        </script>
</section>
</body>
</html>
