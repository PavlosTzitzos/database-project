...
<body>
    <section class="header">
        ...
        #create query
        $q_insert = "INSERT INTO COMPANY(COMPANY_NAME,HQ_ADDRESS,INCOME_OUTCOME,NUMBER_OF_SALESMEN,NUMBER_OF_FACTORIES,DRUG_RATE) VALUES('$company_name','$hqaddress','$in_out','$n_salesmen','$n_factories','$new_drug_rate') ";
