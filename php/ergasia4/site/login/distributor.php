    ...
    <section class="header">
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            <form class=\"App\" action=\"distributor.html\" method=\"POST\">
                <h1>Hello </h1> <h2>$distributor_name</h2>
                <br>
                <p1>Number of distribution points : $distribution_points</p1> <br>
                <p1>Total Capacity : $distribution_capacity m<sup>3</sup></p1> <br>
                <p1>Mean Distribution Time : $mean_distribution_time days</p1> <br>
                <p1>Distribution Range : $distribution_range Km</p1> <br>
                <br>
