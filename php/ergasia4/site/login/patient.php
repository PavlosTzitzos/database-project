    ...
    <section class="header">
        ...
        <?php
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                $result3 = mysqli_query($con,"SELECT COMPANY_NAME, DRUG_NAME, SERIAL_CODE FROM DRUG WHERE SERIAL_CODE IN (
                    SELECT SERIAL_CODE FROM PRESCRIPTION WHERE PATIENT_SSN = '$patient_ssn') ");
                ?>
                <html> <body>
