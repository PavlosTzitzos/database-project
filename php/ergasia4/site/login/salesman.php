    ...
    <section class="header">
        ...
        <?php
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                $salary = $row['SALARY'];
                $row2 = mysqli_fetch_assoc(mysqli_query($con,"SELECT DRUG_NAME FROM DRUG WHERE COMPANY_NAME = '$company_name' AND SERIAL_CODE = '$drug_s_c'"));
                ...
                <form class=\"App\" action=\"salesman.html\" method=\"POST\">
                    ...
                    <p1>Experience in $company_name : $experience years</p1> <br>
                    <p1>Salary : $salary $</p1>
                    <br>
