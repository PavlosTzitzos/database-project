...
<body>
    <section class="header">
        ...
        $query = "SELECT * FROM STATE_DEPOSIT_OF_PHARMACEUTICALS WHERE CITY = '$sdop_city' ";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            <form class=\"App\" action=\"sdop.html\" method=\"POST\">
                <h1>Hello </h1><h2>$sdop_city</h2>
                <br>
                <p1>ADDRESS : $sdop_address</p1> <br>
                <p1>Range : $sdop_range billion $ </p1> <br>
                <p1>Capacity : $sdop_capacity </p1> <br>
                <p1>Delivery time : $sdop_delivery_time</p1> <br>
                <br>
