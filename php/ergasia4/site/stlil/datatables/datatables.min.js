 ...
 *   https://datatables.net/download/#dt/dt-1.10.20/af-2.3.4/b-1.6.1/b-flash-1.6.1/b-html5-1.6.1
 *
 * Included libraries:
 *   DataTables 1.10.20, AutoFill 2.3.4, Buttons 1.6.1, Flash export 1.6.1, HTML5 export 1.6.1
 */
...
(function (f) {
	...
	function sb(a) {
		...
		e.append('<div class="addbutton"><button type="button" name="add" id="add" class="btn btn-info"> Προσθηκη </button></div')
		a.nHolding = c[0];
		a.nTableWrapper = e[0];
	...
	q.defaults = {
		...
		oLanguage: {
			...
			sInfo: "Προβολή _START_ με _END_ απο _TOTAL_ στοιχεία",
			sInfoEmpty: "Προβολή 0 με 0 απο 0 στοιχεία",
			sInfoFiltered: "(filtered from _MAX_ total entries)",
			sInfoPostFix: "",
			sDecimal: "",
			sThousands: ",",
			sLengthMenu: "_MENU_ <span class='counter'> ανα σελίδα </span>",
			sLoadingRecords: "Φορτωνει...",
	...
	q.ext = C = {
		buttons: {},
		classes: {},
		build: "dt/dt-1.10.20/af-2.3.4/b-1.6.1/b-flash-1.6.1/b-html5-1.6.1",
		errMode: "alert",
		feature: [],
		search: [],
		selector: {
...
(function (a) {
	...
	var k = a.fn.dataTable,
		...
		m = function (b, d) {
			...
			this.c = a.extend(!0, {}, k.defaults.autoFill,
				m.defaults, d);
			this.s = {
				dt: new k.Api(b),
			...
			this.dom = {
				...
				list: a('<div class="dt-autofill-list">' + this.s.dt.i18n("autoFill.info",
					"") + "<ul/></div>"),
				dtScroll: null,
				offsetParent: null
			};
	...
	a.extend(m.prototype, {
		...
		_attach: function (b) {
			var d = this.s.dt,
				...
				f = this.dom.handle,
				g = this.s.handle;
			c && -1 !== d.columns(this.c.columns).indexes().indexOf(c.column) ? (this.dom.offsetParent || (this.dom.offsetParent = a(d.table().node()).offsetParent()), g.height && g.width || (f.appendTo("body"), g.height =
				f.outerHeight(), g.width = f.outerWidth()), d = this._getPosition(b, this.dom.offsetParent), this.dom.attachedTo = b, f.css({
		...
		_focusListener: function () {
			...
			if ("focus" === f) d.on("key-focus.autoFill", function (c, d, a) {
				b._attach(a.node())
			}).on("key-blur.autoFill", function (c, a, d) {
				b._detach()
			});
			else if ("click" === f) a(d.table().body()).on("click" + c, "td, th", function (c) {
				b._attach(this)
			}), a(e.body).on("click" + c, function (c) {
				a(c.target).parents().filter(d.table().body()).length ||
					b._detach()
			});
			else a(d.table().body()).on("mouseenter" + c, "td, th", function (c) {
				b._attach(this)
		...
		_mousemove: function (b) {
			...
			if ("td" === a || "th" === a) this._drawSelection(b.target, b), this._shiftScroll(b)
		},
		_mouseup: function (b) {
			...
			if (f.row !== g.row || f.column !== g.column) {
				...
				if (a("div.DTE", h.node()).length) {
					...
					g = [];
					for (var m = c.settings()[0], x = m.aoColumns, q = c.columns(this.c.columns).indexes(), p = 0; p < k.length; p++) g.push(a.map(f, function (b) {
						var a = c.row(":eq(" + k[p] + ")", {
							page: "current"
						});
		...
		_shiftScroll: function (b) {
			...
			null !== c.dtLeft && b.pageX <
				c.dtLeft + 65 ? m = -5 : null !== c.dtLeft && b.pageX > c.dtLeft + c.dtWidth - 65 && (m = 5);
			n || k || l || m ? (c.windowVert = n, c.windowHoriz = k, c.dtVert = l, c.dtHoriz = m, f = !0) : this.s.scrollInterval && (clearInterval(this.s.scrollInterval), this.s.scrollInterval = null);
				...
				if (null !== this.c.update ? this.c.update : !this.c.editor) {
					for (var d = 0, g = a.length; d < g; d++)
						for (var e = 0, h = a[d].length; e < h; e++) {
							var k = a[d][e]; - 1 !== c.indexOf(k.index.column) && k.cell.data(k.set)
						}
					b.draw(!1)
				}
		...
		increment: {
			...
			execute: function (b, d, c) {
				...
				for (var f = 0, g = d.length; f < g; f++)
					for (var e = 0, h = d[f].length; e < h; e++) d[f][e].set = b, b += c
			}
		},
		fill: {
			available: function (b, a) {
			...
			execute: function (b, a, c) {
				...
				for (var d = a.length; c < d; c++)
					for (var e = 0, h = a[c].length; e < h; e++) a[c][e].set =
						b
			}
		},
		fillHorizontal: {
			...
			execute: function (b, a, c) {
				...
				for (c = a.length; b < c; b++)
					for (var d = 0, e = a[b].length; d < e; d++) a[b][d].set = a[b][0].data
			}
		},
		fillVertical: {
			available: function (b, a) {
	...
	t.register("autoFill().enabled()", function () {
		...
		return b.autoFill ? b.autoFill.enabled() :
			!1
	});
	...
	a(e).on("preInit.dt.autofill", function (b, d, c) {
		"dt" === b.namespace && (b = d.oInit.autoFill, c = k.defaults.autoFill, b || c) && (c = a.extend({}, b, c), !1 !== b && new m(d, c))
	});
	k.AutoFill = m;
	return k.AutoFill = m
});
